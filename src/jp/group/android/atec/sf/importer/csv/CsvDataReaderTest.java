...
public class CsvDataReaderTest extends AndroidTestCase {

    public void testRead() {
        InputStream in = ResourceUtils.openFromAsset(getContext(), "sqliteCsvDataReaderTest/test.csv");
    ...
    public void testIgnoreRead() {
        InputStream in = ResourceUtils.openFromAsset(getContext(), "sqliteCsvDataReaderTest/ignore.csv");
